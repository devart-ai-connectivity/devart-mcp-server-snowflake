// --------------------------------------------------------------------------
// <copyright file="OdbcSnowflakeForeignKeysTool.cs" company="Devart">
//
...
{
  internal sealed class OdbcSnowflakeForeignKeysTool(McpConfiguration serverConfiguration) : ForeignKeysTool(serverConfiguration)
  {
