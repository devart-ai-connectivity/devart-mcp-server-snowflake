// --------------------------------------------------------------------------
// <copyright file="OdbcSnowflakePrimaryKeysTool.cs" company="Devart">
//
...
namespace Devart.AI.McpServer.Odbc.Snowflake.Tools
{
  internal sealed class OdbcSnowflakePrimaryKeysTool(McpConfiguration serverConfiguration) : PrimaryKeysTool(serverConfiguration)
  {
